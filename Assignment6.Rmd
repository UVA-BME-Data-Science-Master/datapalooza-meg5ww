...
###2. Using the function cbind, create a 10 x 5 matrix with first column x=1:10. Then add 2x, 3x, 4x and 5x to columns 2 through 5. What is the sum of the elements of the 7th row?
...
`X %*% matrix(1,ncol(X) )` is not equivalent to X.
...
The fitted value for the B samples is 7.
...
###The fitted values from a linear model can be obtained with:
